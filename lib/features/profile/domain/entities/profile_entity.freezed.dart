...
mixin _$ProfileEntity {
 ...
 String get id; String get name; String get email; String? get bio; String? get avatarUrl;
...
@override
String toString() {
  return 'ProfileEntity(id: $id, name: $name, email: $email, bio: $bio, avatarUrl: $avatarUrl)';
}
...
@useResult
$Res call({
 String id, String name, String email, String? bio, String? avatarUrl
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String? bio,  String? avatarUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String? bio,  String? avatarUrl)  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity():
return $default(_that.id,_that.name,_that.email,_that.bio,_that.avatarUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String email,  String? bio,  String? avatarUrl)?  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.bio,_that.avatarUrl);case _:
  return null;
...
class _ProfileEntity extends ProfileEntity {
  const _ProfileEntity({required this.id, required this.name, required this.email, this.bio, this.avatarUrl}): super._();
